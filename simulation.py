...
from repo import count_objects_executing, get_waiting_equipment, move_next_step, number_of_vacancies
...
def simular_pipeline() -> None:
    ...
    iter = IntervalIterator(inicio, fim, timedelta(minutes=15))
